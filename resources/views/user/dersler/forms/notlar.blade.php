...
<div class="card shadow-sm">
    ...
    <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('user.ders.notlari.duzenle', $course->id) }}" class="btn btn-warning px-4">
                ...
                <tbody>
                    @forelse($students as $student)
                        @php
                            ...
                            $butunlemeStudentExam = $butunleme
                                ? $studentExams->where('exam_id', $butunleme->id)->first()
                                : null;
                        @endphp
                        <tr>
